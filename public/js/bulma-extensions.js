(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["/js/bulma-extensions"],{
...
document.addEventListener('DOMContentLoaded', function () {
  // Cookies
  var cookieBookModalName = 'bulma_closed_book_modal'; // var cookieBookModal = Cookies.getJSON(cookieBookModalName) || false;
  // Sidebar links
  ...
  var scrollFactor = 0;
  var currentTranslate = 0; // Anchors highlight
  ...
  function highlightAnchor() {
    ...
    if (past_anchors.length > 0) {
      past_anchors.forEach(function (key, index) {
        ...
        anchor.nav_el.className = 'is-past'; // Keep track of the bottom most item
...
/***/ 1:
/*!************************************************!*\
  !*** multi ./resources/js/bulma-extensions.js ***!
  \************************************************/
/*! no static exports found */
